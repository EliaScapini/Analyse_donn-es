...
liste=dir(['C:\Users\colin\Desktop\APEAS1\data\ID05','\energyBox*.csv']);
Wh=[];
temps=[];
WhDay=[]
...
for j=1:length(liste)
    ...
    ['C:\Users\colin\Desktop\APEAS1\data\ID05\',cour_jour]
    fid=fopen(['C:\Users\colin\Desktop\APEAS1\data\ID05\',cour_jour],'r');
    ...
    temps=[temps; datenum(donnees_moins{1})];
