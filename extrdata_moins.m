...
liste=dir(['C:\Users\colin\Desktop\APEAS1\data\ID13','\energyBox*.csv']);
Wh=[];
temps=[];
WhDay=[]
Day=[]
...
for j=1:length(liste)
    ...
    ['C:\Users\colin\Desktop\APEAS1\data\ID13\',cour_jour]
    fid=fopen(['C:\Users\colin\Desktop\APEAS1\data\ID13\',cour_jour],'r');
    ...
    temps=[temps; str2num(datestr(donnees_moins{1},'dd'))];
